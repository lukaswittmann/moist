...
module test_cavity_drop_integration
   ...
   type(integration_case_type) :: cases(36) = [ &
                                  integration_case_type(1.0_wp, 1.0_wp, 0.0_wp, "MB16-43", "Ar", &
                                                        221.742887_wp, 310.437355_wp), &
                                  integration_case_type(2.0_wp, 1.0_wp, 0.0_wp, "MB16-43", "Ar", &
                                                        221.742887_wp, 310.437355_wp), &
                                  integration_case_type(2.0_wp, 1.0_wp, 1.0_wp, "MB16-43", "Ar", &
                                                        221.742887_wp, 310.437355_wp), &
                                  integration_case_type(10.0_wp, 1.0_wp, 0.0_wp, "MB16-43", "Ar", &
                                                        221.742887_wp, 310.437355_wp), &
                                  integration_case_type(1.0_wp, 1.0_wp, 0.0_wp, "MB16-43", "O2", &
                                                        242.589143_wp, 353.723353_wp), &
                                  integration_case_type(2.0_wp, 1.0_wp, 0.0_wp, "MB16-43", "O2", &
                                                        196.161273_wp, 255.138423_wp), &
                                  integration_case_type(2.0_wp, 1.0_wp, 1.0_wp, "MB16-43", "O2", &
                                                        196.161273_wp, 255.138423_wp), &
                                  integration_case_type(3.0_wp, 1.0_wp, 0.0_wp, "MB16-43", "O2", &
                                                        185.924268_wp, 233.928477_wp), &
                                  integration_case_type(3.0_wp, 1.0_wp, 1.0_wp, "MB16-43", "O2", &
                                                        185.924268_wp, 233.928477_wp), &
                                  integration_case_type(10.0_wp, 1.0_wp, 0.0_wp, "MB16-43", "O2", &
                                                        179.419066_wp, 218.353773_wp), &
                                  integration_case_type(1.0_wp, 1.0_wp, 0.0_wp, "MB16-43", "CH4", &
                                                        396.929665_wp, 742.412003_wp), &
                                  integration_case_type(2.0_wp, 1.0_wp, 0.0_wp, "MB16-43", "CH4", &
                                                        255.697218_wp, 380.888334_wp), &
                                  integration_case_type(2.0_wp, 1.0_wp, 1.0_wp, "MB16-43", "CH4", &
                                                        270.055161_wp, 414.747388_wp), &
                                  integration_case_type(3.0_wp, 1.0_wp, 1.0_wp, "MB16-43", "CH4", &
                                                        229.987373_wp, 323.622720_wp), &
                                  integration_case_type(10.0_wp, 1.0_wp, 0.0_wp, "MB16-43", "CH4", &
                                                        201.379772_wp, 261.188771_wp), &
                                  integration_case_type(2.0_wp, 1.0_wp, 0.0_wp, "Amino20x4", "THR_xab", &
                                                        871.709782_wp, 2046.069766_wp), &
                                  integration_case_type(3.0_wp, 1.0_wp, 0.0_wp, "Amino20x4", "THR_xab", &
                                                        802.552998_wp, 1673.692695_wp), &
                                  integration_case_type(3.0_wp, 1.0_wp, 1.0_wp, "Amino20x4", "THR_xab", &
                                                        816.233266_wp, 1801.648358_wp), &
                                  integration_case_type(5.0_wp, 1.0_wp, 1.0_wp, "Amino20x4", "THR_xab", &
                                                        778.058686_wp, 1516.976987_wp), &
                                  integration_case_type(10.0_wp, 1.0_wp, 0.0_wp, "Amino20x4", "THR_xab", &
                                                        782.802167_wp, 1410.364379_wp), &
                                  integration_case_type(1.0_wp, 1.0_wp, 0.0_wp, "MB16-43", "16", &
                                                        1033.798426_wp, 3088.935546_wp), &
                                  integration_case_type(2.0_wp, 1.0_wp, 0.0_wp, "MB16-43", "16", &
                                                        739.232911_wp, 1734.806473_wp), &
                                  integration_case_type(2.0_wp, 1.0_wp, 1.0_wp, "MB16-43", "16", &
                                                        775.484041_wp, 1921.288922_wp), &
                                  integration_case_type(3.0_wp, 1.0_wp, 1.0_wp, "MB16-43", "16", &
                                                        703.771421_wp, 1567.182120_wp), &
                                  integration_case_type(5.0_wp, 1.0_wp, 1.0_wp, "MB16-43", "16", &
                                                        690.487755_wp, 1425.662212_wp), &
                                  integration_case_type(2.0_wp, 1.0_wp, 0.0_wp, "But14diol", "30", &
                                                        577.749734_wp, 1207.837574_wp), &
                                  integration_case_type(2.0_wp, 1.0_wp, 1.0_wp, "But14diol", "30", &
                                                        634.177253_wp, 1431.003011_wp), &
                                  integration_case_type(3.0_wp, 1.0_wp, 0.0_wp, "But14diol", "30", &
                                                        519.505143_wp, 980.963503_wp), &
                                  integration_case_type(3.0_wp, 1.0_wp, 1.0_wp, "But14diol", "30", &
                                                        533.169514_wp, 1051.688680_wp), &
                                  integration_case_type(5.0_wp, 1.0_wp, 1.0_wp, "But14diol", "30", &
                                                        496.399532_wp, 882.073907_wp), &
                                  integration_case_type(10.0_wp, 1.0_wp, 0.0_wp, "But14diol", "30", &
                                                        493.931152_wp, 816.379242_wp), &
                                  integration_case_type(2.0_wp, 0.0_wp, 1.0_wp, "MB16-43", "CH4", &
                                                        243.767818_wp, 354.652628_wp), &
                                  integration_case_type(3.0_wp, 0.0_wp, 1.0_wp, "Amino20x4", "THR_xab", &
                                                        789.581576_wp, 1694.721566_wp), &
                                  integration_case_type(3.0_wp, 0.0_wp, 1.0_wp, "But14diol", "30", &
                                                        512.762446_wp, 981.787682_wp), &
                                  integration_case_type(3.0_wp, 0.0_wp, 1.0_wp, "MB16-43", "16", &
                                                        690.329407_wp, 1491.585502_wp), &
                                  integration_case_type(2.0_WP, 0.0_WP, 1.0_WP, "MB16-43", "O2", &
                                                        184.603535_WP, 231.274026_WP) &
                                  ]

...
contains
   ...
   pure subroutine wrap_ssyrk(amat, cmat, uplo, trans, alpha, beta)
      real(sp), intent(in) :: amat(:, :)
      real(sp), intent(inout) :: cmat(:, :)
      character(len=1), intent(in), optional :: uplo
   ...
   end subroutine wrap_ssyrk

   pure subroutine wrap_dsyrk(amat, cmat, uplo, trans, alpha, beta)
      real(dp), intent(in) :: amat(:, :)
      real(dp), intent(inout) :: cmat(:, :)
      character(len=1), intent(in), optional :: uplo
      character(len=1), intent(in), optional :: trans
      ...
      call blas_syrk(ula, tra, n, k, a, amat, lda, b, cmat, ldc)
   end subroutine wrap_dsyrk

end module moist_math_blas_level3

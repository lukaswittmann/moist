...
The MOIST library seamlessly integrates with other Fortran projects via module interfaces,
...
The library provides a structure type which is used to represent all geometry related informations in MOIST.
